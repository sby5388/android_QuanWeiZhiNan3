...
public class PicassoAdapter extends ZhuangbiAdapter {
    public PicassoAdapter(Context context, ZbDownloadHandlerThread<ZhuangbiHolder> handlerThread,ZhuangbiOnclickListener listener) {
        super(context, handlerThread,listener);
    }
